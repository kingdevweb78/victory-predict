...
export const usersAPI = { getAll: () => api.get('/users'), getById: (id) => api.get(`/users/${id}`), update: (id, data) => api.put(`/users/${id}`, data), delete: (id) => api.delete(`/users/${id}`) };
...
export const predictionsAPI = { getAll: (params) => api.get('/predictions', { params }), create: (data) => api.post('/predictions', data), update: (id, data) => api.put(`/predictions/${id}`, data), delete: (id) => api.delete(`/predictions/${id}`) };
...
export const adminAPI = { stats: () => api.get('/admin/stats'), backup: () => api.post('/admin/backup'), restore: (filename) => api.post('/admin/restore', { filename }), logs: (params) => api.get('/admin/logs', { params }) };
