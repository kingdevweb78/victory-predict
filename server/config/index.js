...
module.exports = {
  ...
  jwtSecret: process.env.JWT_SECRET || 'vp-jwt-secret-key-2024',
  jwtExpire: '30d',
  botName: 'Victory Predict',
  prefix: '.',
  ...
  paymentInfo: {
    moncash: { name: 'MonCash', number: process.env.MONCASH_NUMBER || '+50955394345' },
    natcash: { name: 'NatCash', number: process.env.NATCASH_NUMBER || '+50955394345' },
  },
  webhookSecret: 'vp-webhook-secret',
  languages: ['ht', 'en', 'fr'],
  defaultLanguage: 'ht',
  freeDailyLimit: 3,
  vipDailyLimit: 20,
